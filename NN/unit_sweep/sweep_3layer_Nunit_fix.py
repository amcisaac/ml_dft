...
def train_model_3layer(X_train,y_train,X_test,y_test,N_units,acts,loss_fn,epochs,batch_size):
    ...
    N_units1,N_units2,N_units3 = N_units
    act1,act2,act3 = acts
...
for N_units in units:
    ...
    epochs = 20
    batch_size = 32
    print('Number of layers: ', 3,flush=True)
    print('Number of units in layer [1,2,3]: ',N_units,flush=True)
    print('Activation function in layer [1,2,3]: ',acts,flush=True)
    print('Loss function: ',loss_fn,flush=True)
    print('Number of epochs: ',epochs,flush=True)
    print('Batch size: ',batch_size,flush=True)
    print('',flush=True)

    train_model_3layer(train_M,train_E_arr,test_M,test_E_arr,N_units,acts,loss_fn,epochs,batch_size)
    print('',flush=True)
