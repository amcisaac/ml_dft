...
units4 = [15,5]
units5 = [35,25,15,5]
for N_unit1 in units1:
    for N_unit2 in units2:
        for N_unit3 in units3:
            for N_unit4 in units4:
                for N_unit5 in units5:

                    N_units = [N_unit1,N_unit2,N_unit3,N_unit4,N_unit5]
                    ...
                    train_model_5layer(train_M,train_E_arr,test_M,test_E_arr,N_units,acts,loss_fn,epochs,batch_size)
                    print('',flush=True)
