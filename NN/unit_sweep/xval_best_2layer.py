...
def train_model_2layer(X_train,y_train,X_test,y_test,N_units,acts,loss_fn,epochs,batch_size):
    model = Sequential()

    N_units1,N_units2 = N_units
    act1,act2 = acts
...
def xval_learning_alg(data, Es, k,N_units,acts,loss_fn,epochs,batch_size):
    ...
    for j in range(0,k):
        ...
        train_loss,train_mse,train_mae,test_loss,test_mse,test_mae=train_model_2layer(train_data,train_E_arr,test_data,test_E_arr,N_units,acts,loss_fn,epochs,batch_size)
...
epochs = 20
batch_size = 32
print('Number of layers: ', 2,flush=True)
print('Number of units in layer [1,2]: ',N_units,flush=True)
print('Activation function in layer [1,2]: ',acts,flush=True)
