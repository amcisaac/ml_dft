...
max_errs = abserr[abserr>=0.5]
max_signederr = sigerr[abserr>=0.5]
max_smiles = smiles[abserr>=0.5]
...
min_errs = abserr[abserr<=0.0001]
min_smiles = smiles[abserr<=0.0001]
min_signederr = sigerr[abserr<=0.0001]
